...
class Decoration(val context: Context) : RecyclerView.ItemDecoration() {
    override fun onDrawOver(canvas: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val overlapDrawable = ResourcesCompat.getDrawable(context.resources, R.drawable.deco_img_opacity, null)
        ...
        canvas.drawBitmap(
            BitmapFactory.decodeResource(context.resources, R.drawable.deco_img_opacity),
